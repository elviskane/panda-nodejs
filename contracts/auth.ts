  ...
  */
  interface ProvidersList {
    ...
    */
    ...
    rider: {
      implementation: LucidProviderContract<typeof Rider>
      config: LucidProviderConfig<typeof Rider>
    }
  }
  ...
  */
  interface GuardsList {
    ...
    */
    ...
    api: {
      implementation: OATGuardContract<'customer', 'api'>
      config: OATGuardConfig<'customer'>
      client: OATClientContract<'customer'>
    }

    rider: {
      implementation: OATGuardContract<'rider', 'rider'>
      config: OATGuardConfig<'rider'>
      client: OATClientContract<'rider'>
    }
  }
}
